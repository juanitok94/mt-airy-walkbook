...
This file does not resolve or guess at any fact. Every hours/detail
value quoted below is what's currently in shops.json, included only
so it can be checked against reality, not asserted as correct.
Update shops.json separately once each item is confirmed.
...
- [ ] Verify hours (currently listed: Mon–Fri 5:45AM–1:45PM, Sat 5:45AM–1:15PM, Sun closed)
- [ ] Confirm pork chop sandwich recipe details (currently described as battered pork, mustard, cole slaw, chili, onion)
- [ ] Add Instagram handle if available (currently none on file)
- [ ] Add website if available (currently none on file)

## Stop 2 — Floyd's City Barber Shop
129 N Main St, Mount Airy, NC 27030

- [ ] Verify hours (currently listed: Tue–Fri 7AM–5PM, Sat 7AM–3PM, closed Mon & Sun)
- [ ] Confirm Russell Hiatt Jr. is the current barber
- [ ] Add contact info if available (phone, Instagram, website — all currently none on file)

## Stop 3 — Opie's Candy Store
135 N Main St, Mount Airy, NC 27030

- [ ] Verify hours (currently listed: Mon–Sat 10AM–5PM, Sun 11AM–4PM; note says hours may vary seasonally)
- [ ] Confirm peanut butter fudge is still made in-house
- [ ] Add Instagram handle if available (currently none on file)
- [ ] Add website if available (currently none on file)

## Stop 4 — Pages Books & Coffee
192 N Main St, Mount Airy, NC 27030

- [ ] Verify hours (currently listed: Mon–Sat 8AM–6PM, Sun 10AM–4PM; note says coffee bar may close earlier than the bookshop)
- [ ] Confirm coffee roaster source (currently described only as "a small roaster in the region")
- [ ] Confirm local history shelf detail (self-published Mount Airy timeline in the back corner)
- [ ] Add Instagram handle if available (currently none on file)
- [ ] Add website if available (currently none on file)

## Stop 5 — Barney's Cafe
206 N Main St, Mount Airy, NC 27030

- [ ] Verify hours (currently listed: Mon–Sat 6AM–3PM, Sun 7AM–2PM)
- [ ] Verify menu details (biscuits and gravy, grilled pimento cheese on sourdough, chicken biscuit)
- [ ] Confirm pie case description (pies sell out; copy suggests coming before noon)
- [ ] Add contact info if available (phone, Instagram, website — all currently none on file)

## Stop 6 — Thirsty Souls Community Brewing
238 Market St, Mount Airy, NC 27030

- [ ] Verify hours (currently listed: closed Mon, Tue–Thu 3PM–9PM, Fri 3PM–10PM, Sat 12PM–10PM, Sun 12PM–8PM; note says kitchen hours may differ from tap room hours)
- [ ] Confirm Jan & Maria Kriska ownership details (sleep medicine doctor / biology teacher backstory, Slovakia origin, funeral-home building)
- [ ] Add Instagram handle if available (currently none on file)
- [ ] Add website if available (currently none on file)
...
- [ ] Confirm the Andy Griffith guitar/music exhibit detail
...
- [ ] Confirm current beer names (currently: Mayberry Lager, Stone Faced IPA)
- [ ] Confirm building/granite-industry history detail
- [ ] Add Instagram handle if available (currently none on file)
- [ ] Add website if available (currently none on file)
